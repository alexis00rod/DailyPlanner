    ...
    <div className='section section-row'>
      ...
      <div className='w-full lg:w-1/3 py-4 flex flex-col gap-2 lg:flex-none'>
        ...
        <div className='w-full px-1 py-2 flex flex-col'>
          ...
          <h2 className='px-2 pt-2 text-zinc-600 text-xl dark:text-zinc-400'>Crear cuenta</h2>
        </div>
        {/* Signup body */}
        <div className='w-full px-1 py-1 flex flex-col items-center gap-2'>
          ...
          <div className='w-full flex px-1 py-1'>
            ...
            <div className='grow px-1 py-1'>
              <span className={`mb-1 w-10 h-10 flex items-center justify-center text-xl rounded-lg border-2 border-teal-400 ${signupStep === 1 ? "border-teal-400 text-zinc-100 bg-teal-400" : "border-teal-400 text-teal-400"}`}>
                {signupStep === 1 ? "1" : <i className='fa-solid fa-check'></i>}
              </span>
              <span className='text-sm text-zinc-600 text-center dark:text-zinc-400'>Email y contraseña</span>
            </div>
            <div className='grow px-1 py-1'>
              <span className='w-10 h-10 flex items-center justify-center'>
                <i className='fa-solid fa-chevron-right text-xl text-zinc-400'></i>
              </span>
            </div>
            {/* Step 2 */}
            <div className='grow px-1 py-1'>
              <span className={`mb-1 w-10 h-10 flex items-center justify-center text-xl rounded-lg ${signupStep === 2 ? "bg-teal-400 text-zinc-100" : "bg-zinc-200 text-zinc-400"}`}>2</span>
              <span className='text-sm text-zinc-600 text-center dark:text-zinc-400'>Perfil</span>
            </div>
          </div>
          {/* Signup form */}
          <form className='w-full flex flex-col gap-2'>
            ...
            <div className='w-full px-1 py-1 flex'>
              ...
              ? <button className='btn btn-form' onClick={validateEmailPassword}>Continuar</button>
              : <button className='btn btn-form' onClick={signupProfile}>Finalizar</button>}
            </div>
          </form>
          {/* Back to login */}
