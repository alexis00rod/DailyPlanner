                ...
                <div className="section section-col">
                    ...
                    <div className="w-full max-w-screen-sm mx-auto px-2 py-2 flex flex-wrap gap-2">
                        ...
                        <div className="px-2 flex justify-center gap-4 grow">
                            <div className={`w-full max-w-xs px-3 py-3 bg-slate-200 rounded-lg cursor-pointer ${theme === "light" && "border-4 border-green-500"}`} onClick={() => setTheme("light")}>
                                <div className="px-3 py-3 bg-slate-100 rounded-lg">
                                    <span className="text-slate-900">Claro</span>
                                </div>
                            </div>
                            <div className={`w-full max-w-xs px-3 py-3 bg-slate-800 rounded-lg cursor-pointer ${theme === "dark" && "border-4 border-green-500"}`} onClick={() => setTheme("dark")}>
